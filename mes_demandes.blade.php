      ...
      @forelse($demandes as $demande)
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
          <div class="service-item position-relative">
            <h2 style="border-bottom: 4px solid #ebebed; font-weight: 700; margin: 0 0 20px 0; padding-bottom: 8px; font-size: 22px;">Titul: {{ $demande->projet }}</h2>
            ...
            @elseif($demande->statut == 'valide')
              ...
              <button class="btn readmore stretched-link" style="color:white; background-color:darkblue; border: 1px solid forestgreen;">Zůstaňte: {{ $demande->montant_restant }} CZK</button>
