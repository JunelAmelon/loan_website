      ...
      <div class="row justify-content-between gy-4 ">
        ...
        <div class="col-lg-6 offset-lg-3 " data-aos="fade">
          <form action="{{route('signTreat')}}" method="post" class="form-line">
            @csrf
            <h1 style="text-align: center; padding-bottom:10%;">Přihlášení</h1>
            <p> </p>
            <div class="row gy-3">
              ...
              <div class="col-md-12 ">
                <a href="{{route('givemail')}}">Zapomenuté heslo ?</a>
              </div>


              <button type="submit" style="width:30%;">Přihlásit se</button>
            </div>
