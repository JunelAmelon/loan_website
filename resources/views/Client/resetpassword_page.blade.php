      ...
      <div class="row justify-content-between gy-4 ">
        ...
        <div class="col-lg-6 offset-lg-3 " data-aos="fade">
          <form action="{{route('updateMyPassword')}}" method="post" class="form-line">
            ...
            <div class="row gy-3">
              <label for="">Zadejte své nové heslo</label>
              <div class="col-md-12">
                <input type="password" name="password" class="form-control" placeholder="Vložte své nové heslo"
                  required>
              </div>
              <button type="submit" style="width:30%;">Aktualizovat</button>
            </div>
