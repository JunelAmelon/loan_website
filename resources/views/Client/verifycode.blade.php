    ...
    <div class="container">
      ...
      <div class="row justify-content-between gy-4 ">
        ...
        <div class="col-lg-6 offset-lg-3 " data-aos="fade">
          <form action="{{route('checkResetCode')}}" method="post" class="form-line">
            @csrf

            <div class="row gy-3">
              <label for="">Zadejte obdržený kód</label>
              <div class="col-md-12">
                <input type="text" name="reset_code" class="form-control"
                  placeholder="Zadejte kód, který jste obdrželi e-mailem" required>
              </div>
              <button type="submit" style="width:30%;">Ověřte</button>
            </div>
