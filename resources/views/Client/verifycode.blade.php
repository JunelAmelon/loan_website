    ...
    @endif
          ...
          <div class="col-lg-6 offset-lg-3 " data-aos="fade">
            <form action="{{route('checkResetCode')}}" method="post" class="form-line">
              ...
              <div class="row gy-3">
              <label for="">Entrez le code recu</label>
                <div class="col-md-12">
                  <input type="text" name="reset_code" class="form-control" placeholder="Entrez le code recu par email" required>
                </div>
                  <button type="submit" style="width:30%;">verify</button>
                </div>
