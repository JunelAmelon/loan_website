        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p data-aos="fade-up">
              ...
              Ať už potřebujete neočekávanou finanční injekci, konsolidovat své dluhy, nebo uskutečnit osobní či
              profesionální projekt, jsme tu pro vás, abychom vám pomohli najít nejlepší řešení úvěru přizpůsobené vašim
      ...
      <div class="row justify-content-between gy-4 ">
        ...
        <div class="col-lg-6 offset-lg-3 " data-aos="fade">
          <form action="{{route('registerTreat')}}" method="post" class="form-line">
            @csrf
            <h1 style="text-align: center; padding-bottom:10%;">Registrovat se</h1>
            <p></p>
            <div class="row gy-3">
              ...
              <div class="col-md-12">
                <input type="text" name="prenom" class="form-control" placeholder="Křestní jméno" required>
              </div>
              <div class="col-md-12">
              ...
              <div style="display: flex; flex-direction: row; ">
                <label style="margin-right: 1%; ">Pohlaví :</label>
              ...
              <div class="col-md-12 ">
                <input type="password" class="form-control" name="password_confirmed" placeholder=" potvrďte heslo"
                  required>
              </div>



              <button type="submit" style="width:30%;">Registrovat se</button>
            </div>
